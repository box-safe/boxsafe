Para interpretar um markdown de "prompt-system" e retorná-lo como uma string limpa, precisamos remover todos os elementos de formatação do Markdown (como cabeçalhos, negritos, itálicos, blocos de código, listas, links, etc.) e normalizar o espaçamento.

Aqui está um código TypeScript que realiza essa limpeza passo a passo usando expressões regulares:
