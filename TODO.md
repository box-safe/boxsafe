...
4. extrair para funções/módulos separados: loadBoxConfig, initNavigator, initTasksManager, attemptVersionControl, parseAndDispatchTools, writeArtifactAtomically, buildExecCommand, runValidation
